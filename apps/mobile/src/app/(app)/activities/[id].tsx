...
export default function ActivityDetailPage() {
  ...
  return (
    <ScreenScrollView keyboardAware={isEditing} bottomPadding={16}>
      <View className={'gap-4'}>
        ...
        {!isEditing ? (
          <>
            ...
            {!isOwner ? (
              <View className={'rounded-md bg-app-dark-bg p-4'}>
                <Text className={'mb-3 text-base font-semibold text-app-dark-text'}>Teilnahme</Text>
                {joinError ? <Text className="mb-3 text-sm text-red-300">{joinError}</Text> : null}
